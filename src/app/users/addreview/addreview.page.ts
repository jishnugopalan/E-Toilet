...
changed(){
  ...
  this.authService.viewreview({"toiletid":this.toiletid}).subscribe((res:any)=>{
    console.log(res)
...
this.authService.addreview({"userid":this.authService.userid,"toiletid":this.credentialsForm.value.city,"star":star,"content":this.credentialsForm.value.name}).subscribe(async (res:any)=>{
  console.log(res)
  ...
  this.authService.viewtoiletbyid({"toiletid":this.credentialsForm.value.city}).subscribe((res:any)=>{
    console.log(res)
    this.munid=res.userid
    this.authService.addnotification({"userid":this.munid,"content":"A person reviewed your E-Toilet","ntype":"review",}).subscribe(async (res:any)=>{
      console.log(res)
      ...
      this.authService.addcomplaint({"userid":this.authService.userid,"toiletid":this.credentialsForm.value.city,"content":this.credentialsForm.value.name}).subscribe(async (res:any)=>{
        console.log(res)
        const loading = await this.loadingController.create({
          cssClass: 'my-custom-class',
          message: 'Please wait...',
        ...
        this.authService.viewtoiletbyid({"toiletid":this.credentialsForm.value.city}).subscribe((res:any)=>{
          console.log(res)
          this.munid=res.userid
          this.authService.addnotification({"userid":this.munid,"content":"A person added a complaint about your E-Toilet","ntype":"complaint",}).subscribe(async (res:any)=>{
            console.log(res)
            const toast = await this.toastController.create({
