...
declare var google;
@Component({
  selector: 'app-viewmytoilet',
  templateUrl: './viewmytoilet.page.html',
  styleUrls: ['./viewmytoilet.page.scss'],
})
export class ViewmytoiletPage implements OnInit,AfterContentInit  {
  map;
  loc:any;
  ...
  constructor(public zone: NgZone,private authService: AuthService,private geolocation: Geolocation) { }
      ...
      infoWindow.setPosition(this.pos);
       ...
       museumMarker.addListener("click", function(){
        ...
        const infowindow = new google.maps.InfoWindow({
          ...
          content:'<b>E-Toilet</b> <br>'+m.cityname,
        });
